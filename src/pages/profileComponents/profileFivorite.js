...
import { MDBIcon, MDBCardBody, MDBCardHeader, MDBInput, MDBBtn, MDBTable, MDBTableBody, MDBTableHead  } from 'mdbreact';

const TableFAVPage = (props) => {
  const data_panel = {
    columns: [
      {
  ...
  return(
    <>
      <MDBCardHeader className=" gradient-card-header  d-flex justify-content-between align-items-center py-2 mx-4 mb-3">
        <div>
